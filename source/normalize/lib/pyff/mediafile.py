...
class MediaFile(BaseFile):
    ...
    def __get_episode(self, full_name, m_title):
        # Get file name
    ...
    def __get_title(self, f_name, m_type):
        m_title = None
        f_path, f_name = os.path.split(f_name)
        parts = f_path.split("\\")
